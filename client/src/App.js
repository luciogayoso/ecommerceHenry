  ...
  return (
    <Router>
      ...
      <Route
        ...
        path="/admin"
        component={
          us.typeUser && us.typeUser === "Admin" ? DashboardAdmin : Catalogue
        }
      />
      <Route
        exact
        path="/cart"
        render={() => <Cart islog={us ? us : undefined} />}
      />
      <Route
        exact
        path={["/products", "/products/category/:id"]}
        component={Catalogue}
      />
      <Route exact path="/products/:id" component={Product} onEnter={userlog} />
      <Route
        path="/addCategory"
        component={us.typeUser && us.typeUser === "Admin" ? FormCategory : Home}
      />
      <Route
        exact
        path="/search"
        render={() => <Catalogue Products={productsl.products} />}
      />
      <Route path="/login" component={LoginUser} />
      <Route exact path="/googleLoginSuccess" component={GoogleLoginSuccess} />
      <Route
        path="/listUser"
        component={us.typeUser && us.typeUser === "Admin" ? ListUser : LoginUser}
      />
      <Route path="/addUser" component={FormAddUser} />
      <Route
        exact
        path="/administrar"
        component={us.typeUser && us.typeUser === "Admin" ? FormAdmin : Home}
      />
      <Route
        exact
        path="/administrarAdd"
        component={us.typeUser && us.typeUser === "Admin" ? FormAdminAdd : Home}
      />
      ...
      <Route
        exact
        path="/me"
        component={idus && idus !== undefined ? UserProfile : LoginUser}
      />
      <Route
        exact
        path="/checkout"
        component={idus && idus !== undefined ? Checkout : LoginUser}
      />
      <Route
        exact
        path="/shipping"
        component={idus && idus !== undefined ? Shipping : LoginUser}
      />
      <Route
        exact
        path="/payment"
        component={idus && idus !== undefined ? Payment : LoginUser}
      />
      <Route
        exact
        path="/favoritos"
        component={idus && idus !== undefined ? FavoriteProducts : LoginUser}
      />
      <Route
        exact
        path="/compras"
        component={idus && idus !== undefined ? ComprasUser : LoginUser}
      />
